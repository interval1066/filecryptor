...
// used. Only one (or none) of these macros can be defined at a time.
...
namespace crypto
{
    ...
    public :
        ...
        // If a table for the S-box values is used we've just to look up the
...
template<bool Inverted> uint8_t S_Box<Inverted>::s_sbox[256];
