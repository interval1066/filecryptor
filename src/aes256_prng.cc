...
uint8_t AES256_PRNG::s_counter[] = {0xd0, 0x73, 0xb0, 0xb1,
                                              0xc7, 0xda, 0x04, 0xde,
                                              0x58, 0x12, 0xa1, 0x4d,
                                              0xf6, 0x4d, 0x0f, 0xd3};

// Default value of key
uint8_t AES256_PRNG::s_key[] = {0x08, 0x11, 0x34, 0xe3,
                                              0x73, 0x86, 0xc7, 0xc4,
                                              0xd1, 0x24, 0x3c, 0xb0,
                                              0x3c, 0xde, 0x0d, 0x73,
                                              0xea, 0xb2, 0xa6, 0x78,
...
AES256_PRNG::get(size_t size)
{
    ...
    std::string r(reinterpret_cast<char const *>(get_buffer(buf, size)), size);
    delete [] buf;
    return r;
}
 ...
 *---------------------------------------------*/
unsigned char*
AES256_PRNG::get_buffer(uint8_t* buf, size_t size)
{
    uint8_t* ret = buf;
